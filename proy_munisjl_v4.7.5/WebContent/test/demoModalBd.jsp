...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" data-mensaje="Hola Mundo">Open modal for @mdo</button>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalModificar" data-nombre="Alexander" data-mensaje="Hola Mundo">Prueba Alex</button>
