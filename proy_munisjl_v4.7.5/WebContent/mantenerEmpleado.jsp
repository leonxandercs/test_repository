...
<script src="js/datatable/datatable.crud.empleado.js" ></script>
<!-- -----import --- validation---->
...
<% List<PersonaBean> listEmpleados=(List)session.getAttribute("listaEmpActivos"); %>
<% String codigo=(String)session.getAttribute("new_cod_emp"); %>
</head>
<script>
//
$(document).ready(function(){
	...
	function limpiarfields(){
	 ...
	 function verNuevo(){
	    	var modal =$('#myModalEmpNuevo');
	    	modal.find('.modal-body #idEmpleado').val('1');
    	...
    	<!-- -------------------------------------------------->
			<div class="list-group" style="text-align: center;">
				<a class="list-group-item" href="#">
					<h4 class="list-group-item-heading">MANTENIMIENTO DE EMPLEADOS</h4>
				</a>
			</div>
			<!-- ----------------------------------------------------------- -->
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%" border="1">
 ...
 <!--  -->
        <tbody>
        	<% 
			for(PersonaBean bean:listEmpleados){
			%>
			<tr>
...
<div class="modal-dialog">
  ...
  <form action="ServletEmpleadoCRUD" class="registrar">
...
<div class="modal-dialog">
  <div class="modal-content">
  <form action="ServletEmpleadoCRUD" class="modificar">
    <div class="modal-header">
    	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
